...
#     shuffle(graphs)
    ...
    graphs = pickle.load(open("/Volumes/Lab/Users/gorish/courses/cs224w/project/graph-generation/dataset_common/hexagons", 'rb'))
    graphs_len = len(graphs)
    graphs_test = graphs[int(0.8 * graphs_len):]
    graphs_train = graphs[0:int(0.8*graphs_len)]
    graphs_validate = graphs[int(0.8*graphs_len):]
#     from IPython import embed; embed()

#     graphs_test = pickle.load(open("/Volumes/Lab/Users/gorish/courses/cs224w/project/graph-generation/dataset_common/grid_test_lowvar.p", 'rb'))
